...
require_once 'AMDocType.php';
require_once 'AMDocItemType.php';
require_once 'AXAccountDailyBalance.php';
require_once 'AXAccountPeriodBalance.php'; 

class AXDaySummaryEntry
{
    public $date;
    public $actualDt  = 0;
    public $actualCt  = 0;
...
class AXPeriodSummaryEntry
{
    public $periodTypeId   = null;
    public $periodYear     = null;
    public $period         = null;
    public $periodSequence = null;
    public $actualDays     = 0;
    public $actualDt       = 0;
    public $actualCt       = 0;
    public $actualBal      = 0;
    public $actualRunBal   = 0;
    public $actualMaxBal   = null;
    public $actualMinBal   = null;
    public $actualSumBal   = 0;
    public $unvalDt        = 0;
    public $unvalCt        = 0;
    public $unvalBal       = 0;
    public $unvalRunBal    = 0;
    public $futureDt       = 0;
    public $futureCt       = 0;
    public $futureBal      = 0;
    public $budgetDt       = 0;
...
class AXAccount extends MMObj 
{
    ...
    private function _getDaySummaryTable($dtFrom, &$dtTo, &$isComplete, $debugMode = false) {
        ...
        $tree = new RbppavlTree("AXDaySummaryTable", 3, false, "5M");
