<?php
require_once 'MMDbAuditLog.php';
require_once 'MMDbFieldAuditLog.php';
require_once 'MMDbQueryPerfLog.php';
require_once 'MMDbCache.php';

class MMObj_dbol_Extension implements dbolCallbackInterface	{
	private $dbol = null;
	private $diag = null;
