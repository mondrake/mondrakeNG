...
require_once 'Dbol.php';
require_once 'MMObjInterfaces.php';
require_once 'MMRbppavlInterface.php'; 
require_once 'MMDBReplication.php';
require_once 'MMDiag.php';
...
abstract class MMObj {
    ...
    public function __construct() {
        ...
        if (!isset(self::$dbObj[$this->className])) {
            ...
            $sqlq = "SELECT * FROM #pfx#mm_classes where mm_class_name = '$this->className'";
            $res = self::$dbol->query($sqlq, $limit = NULL, $offset = NULL, $sqlId = NULL, $skipPerfLog = TRUE);
            if (count($res) == 0)    {
...
//        return self::$dbol->setPKColumns(self::$dbObj[$this->className], $cols);
    ...
    public function getDBALVersion() {
         return self::$dbol->getDBALVersion();
    }

    public function getDBALDriver() {
         return self::$dbol->getDBALDriver();
    }

    public function getDbServer() {
         return self::$dbol->getDbServer();
    }

    public function getDbServerName() {
         return self::$dbol->getDbServerName();
    }

    public function getDbServerVersion() {
         return self::$dbol->getDbServerVersion();
    }
    ...
    public function loadChildObjs($tgt, $objName) {
        ...
        include_once $obj['className'] . '.php';
